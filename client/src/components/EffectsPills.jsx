...
const VITAL_STYLE = {
  ...
  nerve:     { label: 'Nerve',     pos: 'border-blood-500/60  text-blood-300',  neg: 'border-blood-700/40  text-blood-300/60'  },
...
export default function EffectsPills({ effects, className = '' }) {
  ...
  const entries = Object.entries(effects).filter(([, v]) => Number.isFinite(v) && v !== 0);
