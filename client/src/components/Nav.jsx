    ...
    <header className="border-b border-ink-100/10 bg-ink-950/85 backdrop-blur">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 py-2 flex items-center gap-2 sm:gap-3">
        <Link
          ...
          <span
            aria-hidden
            className="font-cursive text-gold-400/95 text-xl sm:text-2xl leading-none absolute -bottom-1 right-0 sm:right-1 -translate-y-[12px] select-none pointer-events-none whitespace-nowrap"
