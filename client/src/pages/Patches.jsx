  ...
  return (
    <div className="max-w-3xl mx-auto py-6 space-y-6">
      <div className="text-center">
        <Link to="/" className="relative inline-block hover:opacity-90 transition">
          <span className="font-display text-4xl text-blood-500 leading-none tracking-wide">MAFIA LIFE</span>
          <span
            aria-hidden
            className="font-cursive text-gold-300 text-3xl leading-none absolute inset-0 flex items-center justify-center select-none pointer-events-none whitespace-nowrap z-10"
            style={{
              textShadow: '0 0 12px rgba(0,0,0,0.85), 0 1px 0 rgba(0,0,0,0.7), 0 0 5px rgba(252,211,77,0.45)',
              transform: 'translateY(10%)',
            }}>
            Criminal Empire
          </span>
        </Link>
        <p className="text-xs text-ink-100/55 mt-2 uppercase tracking-[0.25em]">Patches & Updates</p>
      </div>
