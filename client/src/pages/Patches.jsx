    ...
    <div className="max-w-3xl mx-auto py-6 space-y-6">
      <div className="text-center">
        <Link to="/" className="relative inline-block pb-3 hover:opacity-90 transition">
          ...
          <span
            aria-hidden
            className="font-cursive text-gold-400/95 text-2xl leading-none absolute -bottom-1 right-0 -translate-y-[16px] select-none pointer-events-none whitespace-nowrap"
