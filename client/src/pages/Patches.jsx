  ...
  return (
    <div className="max-w-3xl mx-auto py-6 space-y-6">
      <div className="text-center">
        <Link to="/" className="font-display text-4xl text-blood-500 hover:text-blood-400 transition">
          MAFIA LIFE
        </Link>
        <p className="text-xs text-ink-100/55 mt-1 uppercase tracking-[0.25em]">Patches & Updates</p>
      </div>
