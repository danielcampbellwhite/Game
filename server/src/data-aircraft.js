...
export const AIRCRAFT = [
  //  Planes
  { id: 'plane_cessna_172',    name: 'Skyhawk 172',     maker: 'Cessna',     class: 'plane',      tier: 1, bookPrice: 60000   },
  { id: 'plane_beech_baron',   name: 'Baron 58',        maker: 'Beechcraft', class: 'plane',      tier: 2, bookPrice: 350000  },
  { id: 'plane_gulfstream',    name: 'G650',            maker: 'Gulfstream', class: 'plane',      tier: 3, bookPrice: 3500000 },
  //  Helicopters
  { id: 'heli_robinson_r44',   name: 'R44 Raven',       maker: 'Robinson',   class: 'helicopter', tier: 1, bookPrice: 45000   },
  { id: 'heli_bell_407',       name: '407',             maker: 'Bell',       class: 'helicopter', tier: 2, bookPrice: 250000  },
  { id: 'heli_sikorsky_s76',   name: 'S-76',            maker: 'Sikorsky',   class: 'helicopter', tier: 3, bookPrice: 1500000 },
];
...
// Full-tank refill cost. Planes and helis cost a LOT more to fuel
// than cars (the user explicitly wanted refuelling expensive).
export const AIRCRAFT_REFILL_FULL_COST = {
  plane:      { 1: 500,  2: 2000, 3: 10000 },
  helicopter: { 1: 400,  2: 1500, 3: 6000  },
};
