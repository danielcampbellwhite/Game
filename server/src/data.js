...
export const MISC_ITEMS = [
  ...
  { id: 'flowers',         name: 'Bouquet of Flowers', emoji: '', cost: 25,  desc: 'A cheap mood-lifter. Use to bump happiness.',  effects: { happiness: 5 },             wholesale_only: true },
  { id: 'chocolate_box',   name: 'Box of Chocolates',  emoji: '', cost: 55,  desc: 'A small indulgence.',                          effects: { happiness: 8 },             wholesale_only: true },
  { id: 'coffee',          name: 'Espresso Shot',      emoji: '', cost: 40,  desc: 'A jolt of caffeine to keep you grinding.',     effects: { energy: 10 },               wholesale_only: true },
  { id: 'energy_drink',    name: 'Energy Drink',       emoji: '', cost: 80,  desc: 'Sugar and taurine in a can.',                  effects: { energy: 18 },               wholesale_only: true },
  { id: 'cigar',           name: 'Cuban Cigar',        emoji: '', cost: 60,  desc: 'Steadies your hand for the next move.',        effects: { nerve: 2, happiness: 4 },    wholesale_only: true },
  { id: 'whisky',          name: 'Single Malt',        emoji: '', cost: 110, desc: 'Fortifies your spirit, dents your liver.',     effects: { nerve: 3, happiness: 6, health: -3 }, wholesale_only: true },
  { id: 'sandwich',        name: 'Deli Sandwich',      emoji: '', cost: 35,  desc: 'A proper feed.',                               effects: { health: 8, happiness: 3 },   wholesale_only: true },
  { id: 'painkillers',     name: 'Painkillers',        emoji: '', cost: 95,  desc: 'Knocks the edge off a beating.',               effects: { health: 18 },                wholesale_only: true },
  ...
  { id: 'atm_skimmer',     name: 'ATM Skimmer',        emoji: '', cost: 250, desc: 'Card-cloning rig glued over an ATM\'s reader. Consumed on use.', crimeTool: true },

  { id: 'lockpick_set',    name: 'Lockpick Set',       emoji: '', cost: 75,  desc: 'Required for some jobs. Single-use.',          missionOnly: true },
  { id: 'burner_phone',    name: 'Burner Phone',       emoji: '', cost: 50,  desc: 'Untraceable. Burned after one call. Can send a one-off message to a single player.', missionOnly: true },
  ...
  { id: 'smartphone',     name: 'Smartphone',          emoji: '', cost: 1000, desc: 'Pocket internet. Direct messages, live chat, online shopping — anywhere you carry it.', device: 'phone',  portable: true },
  { id: 'duct_tape',       name: 'Duct Tape',          emoji: '', cost: 15,  desc: 'Holds the world together.',                    missionOnly: true },
  { id: 'gloves',          name: 'Leather Gloves',     emoji: '', cost: 30,  desc: 'No fingerprints, no problems.',                missionOnly: true },
  { id: 'ski_mask',        name: 'Ski Mask',           emoji: '', cost: 60,  desc: 'For when subtlety is overrated.',              missionOnly: true },
  { id: 'zip_ties',        name: 'Zip Ties',           emoji: '', cost: 15,  desc: 'For uncooperative bystanders.',                missionOnly: true },
  { id: 'flashlight',      name: 'Tactical Flashlight',emoji: '', cost: 25,  desc: 'Dark places, bright ideas.',                   missionOnly: true },
  { id: 'gas_can',         name: 'Gas Can',            emoji: '', cost: 40,  desc: 'Combustible. Not for the squeamish.',          missionOnly: true },
  { id: 'usb_drive',       name: 'USB Drive',          emoji: '', cost: 60,  desc: 'Encrypted payload, ready to drop.',            missionOnly: true },

  //  Wholesale-only consumables (expansion) 
  { id: 'protein_shake',  name: 'Protein Shake',       emoji: '', cost: 75,  desc: 'Post-gym fuel.',                           effects: { energy: 12, happiness: 2 },        wholesale_only: true },
  { id: 'pizza_slice',    name: 'Pizza Slice',         emoji: '', cost: 50,  desc: 'Greasy, glorious, immediate.',             effects: { energy: 6, happiness: 6 },          wholesale_only: true },
  { id: 'sushi_box',      name: 'Sushi Box',           emoji: '', cost: 150, desc: 'Premium fuel for the discerning hood.',    effects: { health: 6, energy: 8, happiness: 8 }, wholesale_only: true },
  { id: 'kebab',          name: 'Late-Night Kebab',    emoji: '', cost: 60,  desc: 'Soaks up the night.',                      effects: { energy: 8, happiness: 4 },          wholesale_only: true },
  { id: 'donut',          name: 'Glazed Donut',        emoji: '', cost: 20,  desc: 'Cop bait.',                                 effects: { energy: 4, happiness: 3 },          wholesale_only: true },
  { id: 'champagne_b',    name: 'Bottle of Champagne', emoji: '', cost: 550, desc: 'For the close of a big deal.',             effects: { happiness: 25, nerve: 2, health: -2 }, wholesale_only: true },
  { id: 'beer_six',       name: 'Six-Pack of Beer',    emoji: '', cost: 125, desc: 'Liquid courage at scale.',                 effects: { happiness: 10, nerve: 1 },          wholesale_only: true },
  { id: 'tequila',        name: 'Bottle of Tequila',   emoji: '', cost: 220, desc: 'For when whisky is too refined.',          effects: { nerve: 4, happiness: 8, health: -4 }, wholesale_only: true },
  { id: 'caviar',         name: 'Tin of Caviar',       emoji: '', cost: 1000, desc: 'Pure flex.',                              effects: { happiness: 35 },                    wholesale_only: true },
  { id: 'pre_workout',    name: 'Pre-Workout',         emoji: '', cost: 150, desc: 'Cracks open the throttle on your training.', effects: { energy: 26, nerve: 0 },           wholesale_only: true },
  { id: 'first_aid',      name: 'First Aid Kit',       emoji: '', cost: 250, desc: 'Patch yourself up after the alley scrap.', effects: { health: 35 },                       wholesale_only: true },
  { id: 'adrenaline',     name: 'Adrenaline Shot',     emoji: '', cost: 400, desc: 'Bring it.',                                 effects: { nerve: 6, health: 12 },             wholesale_only: true },
  { id: 'vitamins',       name: 'Daily Vitamins',      emoji: '', cost: 30,  desc: 'A small but consistent edge.',             effects: { health: 4, energy: 4 },             wholesale_only: true },
  { id: 'condoms',        name: 'Pack of Condoms',     emoji: '', cost: 18,  desc: 'A man\'s gotta plan.',                      effects: { happiness: 3 },                    wholesale_only: true },
  { id: 'concert_ticket', name: 'Concert Ticket',      emoji: '', cost: 175, desc: 'Two hours of glorious noise.',             effects: { happiness: 20 },                    wholesale_only: true },
  { id: 'movie_ticket',   name: 'Movie Ticket',        emoji: '', cost: 40,  desc: 'A bit of escapism.',                       effects: { happiness: 8 },                     wholesale_only: true },
  { id: 'spa_day',        name: 'Spa Day Voucher',     emoji: '', cost: 500, desc: 'Reset the body and mind.',                 effects: { happiness: 25, energy: 12, health: 12 }, wholesale_only: true },
  { id: 'massage',        name: 'Deep Tissue Massage', emoji: '', cost: 250, desc: 'Knots out, focus in.',                     effects: { health: 10, happiness: 14 },        wholesale_only: true },
  { id: 'sleeping_pills', name: 'Sleeping Pills',      emoji: '', cost: 60,  desc: 'Reset the energy meter.',                  effects: { energy: 35, happiness: -2 },        wholesale_only: true },
  { id: 'gym_membership', name: 'Day Pass — Iron Foundry', emoji: '', cost: 220, desc: 'Walk in fresh.',                effects: { energy: 18, health: 4 },            wholesale_only: true },

  //  New mission props (Murphy's catalogue) 
  { id: 'bolt_cutters',   name: 'Bolt Cutters',        emoji: '',  cost: 90,  desc: 'Padlocks, fences, gates.',                missionOnly: true },
  { id: 'ski_goggles',    name: 'Ski Goggles',         emoji: '', cost: 35,  desc: 'For when the masks aren\'t enough.',       missionOnly: true },
  { id: 'rope',           name: 'Climbing Rope',       emoji: '', cost: 25,  desc: 'Fire-escape special.',                     missionOnly: true },
  { id: 'walkie',         name: 'Walkie-Talkie',       emoji: '', cost: 55,  desc: 'Comms for the crew.',                       missionOnly: true },
  { id: 'fake_id',        name: 'Fake ID',             emoji: '', cost: 100, desc: 'New name, new face on paper.',             missionOnly: true },
  { id: 'cash_bag',       name: 'Money Bag',           emoji: '', cost: 12,  desc: 'For the cinematic getaway.',                missionOnly: true },
  { id: 'pry_bar',        name: 'Pry Bar',             emoji: '', cost: 30,  desc: 'Doors, windows, vending machines.',         missionOnly: true },
  { id: 'wire_cutters',   name: 'Wire Cutters',        emoji: '',  cost: 25,  desc: 'For alarm wires and other inconveniences.', missionOnly: true },
  { id: 'silencer',       name: 'Suppressor',          emoji: '', cost: 150, desc: 'For when subtlety is required.',           missionOnly: true },
  { id: 'crowbar2',       name: 'Crowbar',             emoji: '', cost: 50,  desc: 'Old reliable.',                             missionOnly: true },
